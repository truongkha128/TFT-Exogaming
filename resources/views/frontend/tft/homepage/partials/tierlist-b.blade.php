        ...
        <div class="row">
                ...
                <div class="text-center info-corp">
                    ...
                    <div class="d-flex my-2 justify-content-center gap-2">
                        ...
                        <div class="text-center">
                            <p class="text-uppercase m-0 fw-bold">{{ $championB['description'] }}</p>
            ...
            <div class="col-md-10">
                <div class="list-character justify-content-center">
                    <!-- Team 1  -->
                    @foreach($championB->tierlists_champion as $item_champion)
                ...
                <div class="row pt-5">
                    ...
                    <div class="col-md-6">
                        <div class="tip">
                            <div class="list-character justify-content-center">
                                <!-- Team 1  -->
                                @foreach($championB->tierlists_between as $itemBetween)
                                <div class="hexagon-wrapper relative">
                    ...
                    <div class="col-md-12">
                        <div class="tip">
                            ...
                            @foreach($championB->tierlists_item as $key => $itemTier)
                            <div class="hexagon-wrapper relative">
                                <div class="hexagon">
                                    <div class="avt"
                    ...
                    <p class="title-info-corp pt-2">Xem thêm tại <a href="{{ $championB['link'] }}"> kênh youtube</a></p>
                </div>
